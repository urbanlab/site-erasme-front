...
const documents: Documents = {
    ...
    "\n    query ServicesRubrique($id: Int!) {\n        getRubrique(id: $id) {\n            logo\n            articles {\n                result {\n                    id\n                    titre\n                    texte\n                }\n            }\n        }\n    }\n": types.ServicesRubriqueDocument,
    "\n    query ArticleBasic($id: Int!) {\n        getArticle(id: $id) {\n            id\n            titre\n            texte\n            logo\n        }\n    }\n": types.ArticleBasicDocument,
    "\n    query ArticleAndPrototype($id: Int!) {\n        getArticle(id: $id) {\n            ...articleInformationFields\n            \n            logo\n            texte\n\n            isprototype\n            #Prototypes\n            description_title\n            description\n            description_title_second\n            description_second\n            chiffres_cles\n            description_lateral_title\n            description_lateral\n            developpement\n            # descr_tech_technique\n\n            #We want to fetch all 'mots'\n            mots(pagination: 100) {\n                ...motsAndGroupMotsFromArticleFields\n            }\n\n            #We want to fetch all 'documents' (images)\n            documents (pagination: 100) {\n                ...documentsFromArticleFields\n            }\n\n            auteurs {\n                result {\n                    id\n                    titre\n                }  \n            }\n            \n            rubrique {\n                logo\n            }\n        }\n    }\n": types.ArticleAndPrototypeDocument,
