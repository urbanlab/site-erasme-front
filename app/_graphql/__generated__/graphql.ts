...
export type RubriqueBasicInformationFieldsFragment = { __typename?: 'Rubrique', id?: string | null, titre?: string | null, texte?: string | null, logo?: string | null } & { ' $fragmentName'?: 'RubriqueBasicInformationFieldsFragment' };

export type RubriqueFullInformationFieldsFragment = (
  ...
  & { ' $fragmentRefs'?: { 'RubriqueBasicInformationFieldsFragment': RubriqueBasicInformationFieldsFragment } }
) & { ' $fragmentName'?: 'RubriqueFullInformationFieldsFragment' };
...
export type ArticleFullInformationFieldsFragment = { __typename?: 'Article', id?: string | null, titre?: string | null, texte?: string | null, logo?: string | null, date?: any | null, isprototype?: string | null, documents?: { __typename?: 'DocumentPagination', result?: Array<(
      { __typename?: 'Document' }
...
export type RubriqueQueryVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type RubriqueQuery = { __typename?: 'Query', getRubrique?: (
    { __typename?: 'Rubrique' }
    & { ' $fragmentRefs'?: { 'RubriqueFullInformationFieldsFragment': RubriqueFullInformationFieldsFragment } }
  ) | null };
...
export type SearchQuery = { __typename?: 'Query', recherche: { __typename?: 'RecherchePagination', result?: Array<(
      ...
      { __typename?: 'Document' }
      & { ' $fragmentRefs'?: { 'DocumentBasicInformationFieldsFragment': DocumentBasicInformationFieldsFragment } }
    ) | { __typename?: 'Groupe_mots' } | { __typename?: 'Mot' } | (
      { __typename?: 'Rubrique' }
...
export type AllProjectsAndNestedCollectionsQueryVariables = Exact<{
  ...
  articlesInRubriqueOrderBy?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
  idGroupeMotsForFilter: Scalars['Int']['input'];
  withAuteurs?: InputMaybe<Scalars['Boolean']['input']>;
  whereAuteurs?: InputMaybe<Array<Scalars['String']['input']> | Scalars['String']['input']>;
  idAuteur?: InputMaybe<Scalars['Int']['input']>;
  pagination?: InputMaybe<Scalars['Int']['input']>;
  page?: InputMaybe<Scalars['Int']['input']>;
  withPartenaires?: InputMaybe<Scalars['Boolean']['input']>;
  idPartenaire?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type AllProjectsAndNestedCollectionsQuery = { __typename?: 'Query', rubriques?: { __typename?: 'RubriquePagination', pagination?: (
      ...
      { __typename?: 'Rubrique' }
      & { ' $fragmentRefs'?: { 'ListProjetsFieldsFragment': ListProjetsFieldsFragment } }
    ) | null> | null } | null, getGroupe_mots?: { __typename?: 'Groupe_mots', id?: string | null, titre?: string | null, mots?: { __typename?: 'MotPagination', result?: Array<(
        { __typename?: 'Mot' }
        & { ' $fragmentRefs'?: { 'MotsAndGroupeMotsFieldsFragment': MotsAndGroupeMotsFieldsFragment } }
      ) | null> | null } | null } | null, getAuteur?: (
    { __typename?: 'Auteur' }
...
export const RubriqueDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Rubrique"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getRubrique"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"rubriqueFullInformationFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"rubriqueBasicInformationFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Rubrique"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"titre"}},{"kind":"Field","name":{"kind":"Name","value":"texte"}},{"kind":"Field","name":{"kind":"Name","value":"logo"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"articleBasicInformationFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Article"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"titre"}},{"kind":"Field","name":{"kind":"Name","value":"date"}},{"kind":"Field","name":{"kind":"Name","value":"logo"}},{"kind":"Field","name":{"kind":"Name","value":"isprototype"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"rubriqueFullInformationFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Rubrique"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"rubriqueBasicInformationFields"}},{"kind":"Field","name":{"kind":"Name","value":"articles"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"pagination"},"value":{"kind":"IntValue","value":"500"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"result"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"articleBasicInformationFields"}}]}}]}}]}}]} as unknown as DocumentNode<RubriqueQuery, RubriqueQueryVariables>;
